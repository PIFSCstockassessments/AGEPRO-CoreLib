...
namespace AGEPRO_struct
{
    public class EmpericalRecruitment : RecruitmentModel
    {
        ...
        protected override void ReadRecruitmentModel(StreamReader sr)
        {
            ...
            //obsTable
            this.obsTable = ReadObsTable(sr, this.withSSB);


        }

        protected DataTable ReadObsTable(StreamReader sr, bool useSSB)
        {
            string line;
        ...
        public class TwoStageEmpericalRecruitment : EmpericalRecruitment
        {
            ...
            protected override void ReadRecruitmentModel(StreamReader sr)
            {
                ...
                //lv1Obs 
                this.lv1Obs = base.ReadObsTable(sr, this.withSSB);
                //lv2Obs
                this.lv2Obs = base.ReadObsTable(sr, this.withSSB);
